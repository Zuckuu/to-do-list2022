...
function todoMain() {
  ...
  function renderRow({ todo: inputValue, category: inputValue2, id, date, time, done }) {
    ...
    editSpan.innerText = "";
    editSpan.className = "fa-solid fa-pencil";
  ...
  function renderPageNumbers(arr){
    ...
    pageNumberDiv.innerHTML = `<i class="fa-solid fa-angles-left" data-pagination="firstPage"></i>`;
    
    if(currentPage != 1)
      pageNumberDiv.innerHTML += `<i class="fa-solid fa-chevron-left" data-pagination="previousPage"></i>`;
    ...
    if(currentPage != totalPages)
      pageNumberDiv.innerHTML += `<i class="fa-solid fa-chevron-right" data-pagination="nextPage"></i>`;

      pageNumberDiv.innerHTML += `<i class="fa-solid fa-angles-right" data-pagination="lastPage"></i>`;
  }
